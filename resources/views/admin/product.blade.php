          ...
          <tr>
            ...
            <td>
              @if(!empty($item['images']))
                <img src="{{ asset('storage/app/private/public/uploads/' . $item['images']) }}" width="80" height="80" alt="Product Image">
              @else
                No image
              @endif
            </td>
            <td>
              ...
              <form action="{{ route('admin.product.edit', $item['id']) }}" method="GET" style="display:inline-block;">
    @csrf
    <!-- @method('DELETE') -->
